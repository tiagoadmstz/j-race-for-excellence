...
public class ViewKpi extends javax.swing.JFrame {
    ...
    public ViewKpi() throws Exception {
        setIconImage(new ImageIcon(new PathResource("config/images/icon.jpeg").getFile().getPath()).getImage());
        initComponents();
        HabilitaCampo();
        DataAtual();
    }
    ...
    private void initComponents() {
        ...
        jLabel26.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/cooperstandard/img/logoSemFundo.png"))); // NOI18N
