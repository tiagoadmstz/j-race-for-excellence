        ...
        if (kpiRepository.findAll().isEmpty()) {
            List<Kpi> kpis = Arrays.asList(
                    Kpi.builder().ativo(true).nome("OEE").meta(480L).metodoPontuacao(Arrays.asList(
                            MetodoPontuacao.builder().comparacao(">=").valor(95L).pontuacao(10L).build(),
                            MetodoPontuacao.builder().comparacao(">=").valor(91L).pontuacao(5L).build(),
                            MetodoPontuacao.builder().comparacao("<").valor(91L).pontuacao(0L).build()
                    ...
                    Kpi.builder().ativo(true).nome("SCRAP").meta(480L).metodoPontuacao(Arrays.asList(
                            MetodoPontuacao.builder().comparacao("<=").valor(5L).pontuacao(15L).build(),
                            MetodoPontuacao.builder().comparacao("<=").valor(1L).pontuacao(10L).build(),
                            MetodoPontuacao.builder().comparacao(">").valor(1L).pontuacao(0L).build()
                    )).turnos(Arrays.asList(
                    ...
                    Kpi.builder().ativo(true).nome("DOWNTIME").meta(480L).metodoPontuacao(Arrays.asList(
                            MetodoPontuacao.builder().comparacao("<=").valor(0L).pontuacao(10L).build(),
                            MetodoPontuacao.builder().comparacao(">").valor(0L).pontuacao(0L).build()
                    )).turnos(Arrays.asList(
                    ...
                    Kpi.builder().ativo(true).nome("SETUP").meta(480L).metodoPontuacao(Arrays.asList(
                            MetodoPontuacao.builder().comparacao("<=").valor(3L).pontuacao(10L).build(),
                            MetodoPontuacao.builder().comparacao("<=").valor(10L).pontuacao(5L).build(),
                            MetodoPontuacao.builder().comparacao(">").valor(10L).pontuacao(0L).build()
                    )).turnos(Arrays.asList(
                            Turno.builder().nome("A").totalPontuacao(100L).carro("mercedes.png").build(),
                            Turno.builder().nome("B").totalPontuacao(80L).carro("mclaren.png").build(),
                            Turno.builder().nome("C").totalPontuacao(120L).carro("red-bull.png").build()
                    ...
                    Kpi.builder().ativo(true).nome("BPS").meta(480L).metodoPontuacao(Arrays.asList(
                            MetodoPontuacao.builder().comparacao(">=").valor(100L).pontuacao(10L).build(),
                            MetodoPontuacao.builder().comparacao(">=").valor(90L).pontuacao(5L).build(),
                            MetodoPontuacao.builder().comparacao("<").valor(90L).pontuacao(0L).build()
                    )).turnos(Arrays.asList(
                            Turno.builder().nome("A").totalPontuacao(100L).carro("mercedes.png").build(),
                            Turno.builder().nome("B").totalPontuacao(80L).carro("mclaren.png").build(),
                            Turno.builder().nome("C").totalPontuacao(120L).carro("red-bull.png").build()
                    ...
                    Kpi.builder().ativo(true).nome("SEGURANÇA").meta(480L).metodoPontuacao(Arrays.asList(
                            MetodoPontuacao.builder().comparacao("<=").valor(0L).pontuacao(20L).build(),
                            MetodoPontuacao.builder().comparacao(">").valor(0L).pontuacao(0L).build()
                    )).turnos(Arrays.asList(
                            Turno.builder().nome("A").totalPontuacao(80L).carro("sauber.png").build(),
                            Turno.builder().nome("B").totalPontuacao(120L).carro("force-india.png").build(),
